                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <Reveal>
                        ...
                        <p className="text-gray-600 dark:text-theme-muted text-lg leading-relaxed mb-6">
                            DBS Premier Car Wash began with a simple observation: car owners in Kampala lacked a place that treated vehicles with the respect
                            they deserve. What started as a small, passion-driven operation has grown into the region's most advanced detailing studio.
                        </p>
                        <p className="text-gray-600 dark:text-theme-muted text-lg leading-relaxed mb-8">
                            We don't believe in "quick and dirty." Every car that enters our bay undergoes a rigorous inspection and cleaning process using
                            pH-neutral shampoos, grit-guard bucket systems, and the finest ceramic coatings available globally.
                        </p>
            ...
            <div className="bg-gray-50 dark:bg-theme-surface border-y border-gray-200 dark:border-theme-accent py-24 transition-colors duration-300">
                <div className="max-w-7xl mx-auto px-6 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        {/* Value 2 */}
                        <Reveal delay={100}
                                className="group bg-white dark:bg-theme-black p-8 rounded-3xl border border-gray-200 dark:border-theme-accent hover:border-theme-red dark:hover:border-theme-red transition-all shadow-lg dark:shadow-none">
                            <div className="w-14 h-14 bg-gray-100 dark:bg-theme-accent rounded-full flex items-center justify-center text-theme-red text-2xl mb-6 group-hover:bg-theme-red group-hover:text-white transition-colors">
