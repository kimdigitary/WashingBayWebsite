...
export default function Booking({packages, extras, currency, locations}: Props) {
    ...
    const handleDateChange = (e: { target: { value: any; }; }) => {
        ...
        setDate(val ? new Date(val) : new Date());
    };

    // const displayValue = date instanceof Date && !isNaN(date)
